...
function validateInputs() {
  ...
  const emailValid = ['@gmail.com', '@outlook.com', '@mail.ru']
  .some(domain => emailField.value.endsWith(domain));
...
loginBtn.addEventListener('click', async function (e) {
  ...
  // time changed to 5:30

  const offset = 5.5 * 60 * 60 * 1000; // +5:30 in milliseconds
